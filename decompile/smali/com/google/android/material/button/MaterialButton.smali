...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v1}, Landroidx/appcompat/widget/h;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v4, Lcom/bumptech/glide/g;->r:[I
    ...
    invoke-static {v3, v5}, La3/n;->b(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v3

    iput-object v3, p0, Lcom/google/android/material/button/MaterialButton;->k:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v3, v2, v5}, Ld3/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v3

    iput-object v3, p0, Lcom/google/android/material/button/MaterialButton;->l:Landroid/content/res/ColorStateList;
    ...
    invoke-static {v3, v2, v5}, Ld3/c;->d(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;

    move-result-object v3

    iput-object v3, p0, Lcom/google/android/material/button/MaterialButton;->m:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v8, p2, v1, v0}, Lg3/i;->b(Landroid/content/Context;Landroid/util/AttributeSet;II)Lg3/i$a;
    ...
    invoke-direct {v0, p0, p2}, Lq2/a;-><init>(Lcom/google/android/material/button/MaterialButton;Lg3/i;)V

    iput-object v0, p0, Lcom/google/android/material/button/MaterialButton;->h:Lq2/a;
    ...
    iput p2, v0, Lq2/a;->g:I

    iget-object v1, v0, Lq2/a;->b:Lg3/i;
    ...
    invoke-virtual {v0, p2}, Lq2/a;->c(Lg3/i;)V

    iput-boolean v5, v0, Lq2/a;->p:Z
    ...
    invoke-static {p2, v1}, La3/n;->b(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p2

    iput-object p2, v0, Lq2/a;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {p2, v2, v1}, Ld3/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object p2

    iput-object p2, v0, Lq2/a;->j:Landroid/content/res/ColorStateList;
    ...
    iput-object p2, v0, Lq2/a;->k:Landroid/content/res/ColorStateList;
    ...
    iput-object p2, v0, Lq2/a;->l:Landroid/content/res/ColorStateList;
    ...
    .line 7
    iput-boolean v5, v0, Lq2/a;->o:Z

    iget-object v6, v0, Lq2/a;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v6, v0, Lq2/a;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    :goto_0
    iget v6, v0, Lq2/a;->c:I

    add-int/2addr p2, v6

    iget v6, v0, Lq2/a;->e:I

    add-int/2addr v1, v6

    iget v6, v0, Lq2/a;->d:I

    add-int/2addr v3, v6

    iget v0, v0, Lq2/a;->f:I
...
.method public final a()Z
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->h:Lq2/a;

    if-eqz v0, :cond_0

    iget-boolean v0, v0, Lq2/a;->q:Z
...
.method public getRippleColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lq2/a;->l:Landroid/content/res/ColorStateList;
...
.method public getShapeAppearanceModel()Lg3/i;
    ...
    .line 1
    iget-object v0, v0, Lq2/a;->b:Lg3/i;
...
.method public getStrokeColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lq2/a;->k:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    .line 1
    iget-object v0, v0, Lq2/a;->j:Landroid/content/res/ColorStateList;

    return-object v0

    .line 2
    :cond_0
    invoke-super {p0}, Landroidx/appcompat/widget/h;->getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    .line 1
    iget-object v0, v0, Lq2/a;->i:Landroid/graphics/PorterDuff$Mode;

    return-object v0

    .line 2
    :cond_0
    invoke-super {p0}, Landroidx/appcompat/widget/h;->getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
...
.method public onAttachedToWindow()V
    ...
    .line 1
    invoke-virtual {v0, v1}, Lq2/a;->b(Z)Lg3/f;
...
.method public final onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    invoke-super {p0, p1}, Landroidx/appcompat/widget/h;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
...
.method public final onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-super {p0, p1}, Landroidx/appcompat/widget/h;->onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
...
.method public final onLayout(ZIIII)V
    ...
    invoke-super/range {p0 .. p5}, Landroidx/appcompat/widget/h;->onLayout(ZIIII)V
...
.method public final onTextChanged(Ljava/lang/CharSequence;III)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Landroidx/appcompat/widget/h;->onTextChanged(Ljava/lang/CharSequence;III)V
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 1
    iput-boolean v1, v0, Lq2/a;->o:Z

    iget-object v1, v0, Lq2/a;->a:Lcom/google/android/material/button/MaterialButton;

    iget-object v2, v0, Lq2/a;->j:Landroid/content/res/ColorStateList;
...
.method public setCornerRadius(I)V
    ...
    :cond_0
    iput p1, v0, Lq2/a;->g:I

    const/4 v1, 0x1

    iput-boolean v1, v0, Lq2/a;->p:Z
    ...
    invoke-virtual {v0, p1}, Lq2/a;->c(Lg3/i;)V
...
.method public setInsetBottom(I)V
    ...
    iget v1, v0, Lq2/a;->e:I

    invoke-virtual {v0, v1, p1}, Lq2/a;->d(II)V
...
.method public setInsetTop(I)V
    ...
    iget v1, v0, Lq2/a;->f:I

    invoke-virtual {v0, p1, v1}, Lq2/a;->d(II)V
...
.method public setRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lq2/a;->l:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Lq2/a;->l:Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Lq2/a;->a:Lcom/google/android/material/button/MaterialButton;
...
.method public setStrokeColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lq2/a;->k:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_0

    iput-object p1, v0, Lq2/a;->k:Landroid/content/res/ColorStateList;
...
.method public setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    .line 1
    iget-object v1, v0, Lq2/a;->j:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_1

    iput-object p1, v0, Lq2/a;->j:Landroid/content/res/ColorStateList;

    const/4 p1, 0x0

    .line 2
    invoke-virtual {v0, p1}, Lq2/a;->b(Z)Lg3/f;
    ...
    .line 5
    :cond_0
    invoke-super {p0, p1}, Landroidx/appcompat/widget/h;->setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
...
.method public setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 1
    iget-object v1, v0, Lq2/a;->i:Landroid/graphics/PorterDuff$Mode;

    if-eq v1, p1, :cond_1

    iput-object p1, v0, Lq2/a;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 7
    :cond_0
    invoke-super {p0, p1}, Landroidx/appcompat/widget/h;->setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
