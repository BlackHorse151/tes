...
.field public static k:Landroidx/recyclerview/widget/m$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/recyclerview/widget/m;->j:Ljava/lang/ThreadLocal;

    new-instance v0, Landroidx/recyclerview/widget/m$a;

    invoke-direct {v0}, Landroidx/recyclerview/widget/m$a;-><init>()V

    sput-object v0, Landroidx/recyclerview/widget/m;->k:Landroidx/recyclerview/widget/m$a;
...
.method public final a(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    iget-wide v0, p0, Landroidx/recyclerview/widget/m;->g:J
    ...
    iput-wide v0, p0, Landroidx/recyclerview/widget/m;->g:J

    invoke-virtual {p1, p0}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    :cond_0
    iget-object p1, p1, Landroidx/recyclerview/widget/RecyclerView;->i0:Landroidx/recyclerview/widget/m$b;
...
.method public final b(J)V
    ...
    iget-object v4, p0, Landroidx/recyclerview/widget/m;->f:Ljava/util/ArrayList;
    ...
    iget-object v5, v4, Landroidx/recyclerview/widget/RecyclerView;->i0:Landroidx/recyclerview/widget/m$b;
    ...
    :cond_1
    iget-object v2, p0, Landroidx/recyclerview/widget/m;->i:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Landroidx/recyclerview/widget/m;->f:Ljava/util/ArrayList;
    ...
    :cond_2
    iget-object v6, v5, Landroidx/recyclerview/widget/RecyclerView;->i0:Landroidx/recyclerview/widget/m$b;
    ...
    iget-object v9, p0, Landroidx/recyclerview/widget/m;->i:Ljava/util/ArrayList;
    ...
    iget-object v10, p0, Landroidx/recyclerview/widget/m;->i:Ljava/util/ArrayList;
    ...
    sget-object v2, Landroidx/recyclerview/widget/m;->k:Landroidx/recyclerview/widget/m$a;
    ...
    invoke-virtual {p0, v3, v7, v5, v6}, Landroidx/recyclerview/widget/m;->c(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$a0;

    move-result-object v3

    if-eqz v3, :cond_c

    iget-object v5, v3, Landroidx/recyclerview/widget/RecyclerView$a0;->g:Ljava/lang/ref/WeakReference;
    ...
    iget-object v3, v3, Landroidx/recyclerview/widget/RecyclerView$a0;->g:Ljava/lang/ref/WeakReference;
    ...
    .line 4
    :cond_9
    iget-boolean v5, v3, Landroidx/recyclerview/widget/RecyclerView;->F:Z

    if-eqz v5, :cond_a

    iget-object v5, v3, Landroidx/recyclerview/widget/RecyclerView;->j:Landroidx/recyclerview/widget/b;
    ...
    :cond_a
    iget-object v5, v3, Landroidx/recyclerview/widget/RecyclerView;->i0:Landroidx/recyclerview/widget/m$b;
    ...
    .line 6
    iget-object v6, v3, Landroidx/recyclerview/widget/RecyclerView;->j0:Landroidx/recyclerview/widget/RecyclerView$x;

    iget-object v7, v3, Landroidx/recyclerview/widget/RecyclerView;->p:Landroidx/recyclerview/widget/RecyclerView$d;
    ...
    invoke-virtual {p0, v3, v7, p1, p2}, Landroidx/recyclerview/widget/m;->c(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$a0;
    :try_end_0
...
.method public final c(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$a0;
    ...
    iget-object v3, p1, Landroidx/recyclerview/widget/RecyclerView;->j:Landroidx/recyclerview/widget/b;
    ...
    .line 2
    :cond_2
    iget-object v0, p1, Landroidx/recyclerview/widget/RecyclerView;->g:Landroidx/recyclerview/widget/RecyclerView$r;

    :try_start_0
    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView;->Y()V

    invoke-virtual {v0, p2, p3, p4}, Landroidx/recyclerview/widget/RecyclerView$r;->j(IJ)Landroidx/recyclerview/widget/RecyclerView$a0;
    ...
    :cond_3
    invoke-virtual {v0, p2, v1}, Landroidx/recyclerview/widget/RecyclerView$r;->a(Landroidx/recyclerview/widget/RecyclerView$a0;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :cond_4
    :goto_2
    invoke-virtual {p1, v1}, Landroidx/recyclerview/widget/RecyclerView;->Z(Z)V
...
.method public final run()V
    ...
    iget-object v6, p0, Landroidx/recyclerview/widget/m;->f:Ljava/util/ArrayList;
    ...
    iget-wide v4, p0, Landroidx/recyclerview/widget/m;->h:J
